...
def student_profile(request):
    ...
    # gender = request.user.students.gender
...
#
#             if profile_pic:  # Check if a profile picture is uploaded
#                 # Delete the existing profile picture, if any
#                 if student.profile_pic:
#                     default_storage.delete(student.profile_pic.path)
#
#                 # Save the new profile picture
#                 filename = default_storage.save(profile_pic.name, profile_pic)
#                 student.profile_pic = settings.MEDIA_URL + filename
#
#             student.save()
#
