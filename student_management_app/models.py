...
class Students(models.Model):
    ...
    session_year = models.ForeignKey(SessionYearModel, on_delete=models.CASCADE, null=True)
...
class AttendanceReport(models.Model):
    ...
    student = models.ForeignKey(Students, on_delete=models.DO_NOTHING, related_name='attendance_reports')
